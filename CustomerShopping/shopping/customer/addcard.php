									...
									<div class="row">
										...
										<div id="content" class="12u">
											...
											?>
												...
												<h2>CARD DETAILS</h2>
												<div class="row 50%">
													<div class="6u(narrower)">
														<input type="text" name="card_name" id="card_name" placeholder="NAME ON CARD" required/>
													</div>
												</div>
												<div class="row 50%">
													<div class="6u">
													...
													<div class="6u(narrower)">
														<input type="text" name="card_type" id="card_type" placeholder="CARD TYPE" required/>
													</div>
												</div>
												<div class="row 50%">
													<div class="6u">
														<textarea name="card_ddress" id="card_ddress" placeholder="Billing Address" required></textarea>
													</div>
												</div>
												<div class="row 50%">
													<div class="12u">
														<ul class="actions">
															<li><input type="submit" name="complete_order" id="complete_order" value="Complete Order" class="button alt2"></input></li>
														</ul>
													</div>
												</div>
											</form>
